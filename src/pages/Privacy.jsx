    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans py-12 px-4 sm:px-8 lg:px-12">
      <div className="max-w-4xl mx-auto space-y-8 bg-white p-8 sm:p-12 rounded-3xl border border-slate-200/80 shadow-xs">
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-extrabold text-slate-950">1. Information We Collect</h2>
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-extrabold text-slate-950">2. How We Use Your Data</h2>
          <p className="text-slate-600 font-medium text-sm leading-relaxed">
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-extrabold text-slate-950">3. Authentication & Security</h2>
          <p className="text-slate-600 font-medium text-sm leading-relaxed">
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-extrabold text-slate-950">4. User Content Rights</h2>
          <p className="text-slate-600 font-medium text-sm leading-relaxed">
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-extrabold text-slate-950">5. Contact Us</h2>
          <p className="text-slate-600 font-medium text-sm leading-relaxed">
